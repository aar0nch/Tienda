...
public class ReporteController {
    ...
    //LOS MAPEOS A LOS REPORTES QUE HIZO EL PROFE EN CLASE
    /*
    @GetMapping("/usuarios")
    ...
    @GetMapping("/nombres")
    public ResponseEntity<Resource> reporteNombres(@RequestParam String tipo) 
            throws IOException {
        var reporte="nombres";
        return reporteService.generaReporte(reporte, null, tipo);
    }
    
    //OTRO MAPEO A OTRO REPORTE DEL PROFE
    /*
